...
var en$1 = {
	"tpLinkPlug.entry.name": "TP-Link Plug",
	"tpLinkPlug.entry.description": "Control TP-Link Smart Plug via Web API"
};
var ja$1 = {
	"tpLinkPlug.entry.name": "TP-Link Plug",
	"tpLinkPlug.entry.description": "TP-Linkスマート・プラグをWeb APIで制御する"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"tpLinkPlug.entry.name": "TP-Link Plug",
	"tpLinkPlug.entry.description": "TP-Linkスマート・プラグをウェブ・エーピーアイでせいぎょする"
}
};
...
var en = {
	"tpLinkPlug.name": "TP-Link Plug",
	"tpLinkPlug.setDevicePower": "device [HOST] power [STATE]"
};
var ja = {
	"tpLinkPlug.name": "TP-Link Plug",
	"tpLinkPlug.setDevicePower": "[HOST] のデバイスを [STATE] にする"
};
var translations = {
	en: en,
	ja: ja,
...
var extensionURL = 'https://yokobond.github.io/xcx-tplink-plug/dist/tpLinkPlug.mjs';
/**
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass(ExtensionBlocks, [{
    key: "setDevicePower",
    value: function setDevicePower(args) {
      var body = {
        host: cast.toString(args.HOST),
        power: args.STATE === 'ON'
      };
      var url = new URL('http://localhost:3030');
      url.pathname = 'state';
      ...
      return new Promise(function (resolve) {
        fetch(req).then(function (res) {
          if (res.ok) {
            ...
            resolve("".concat(res.status, ": ").concat(res.statusText, ", URL: ").concat(req.url));
          }
